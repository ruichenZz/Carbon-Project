            ...
            <>
               ...
               >
                  ...
                  <Formik 
                     ...
                     validate={ values => {
                        const errors= {};
                        if (!values.projectName) errors.projectName = "Project Name required"
                        return errors;
                     }}
                     onSubmit={(values, { setSubmitting }) => {
                        checkPackageNameAvailable(values.projectName).then(isAvailable => {
                           if (isAvailable) {
                              ...
                              alert(`This project name already exists! Please use another name.`)
                           }
                        })
                     }}
                  >
                  {formik => (
                     <form onSubmit={formik.handleSubmit}>
                        ...
                        (<div>{formik.errors.projectName}</div>) : null}
