...
export const getUsers = () => (get(`${API_URL}/project/user`).then(res => res.data));
...
export const checkPackageNameAvailable = packageName => (get(`${API_URL}/git/checkNameAvailable/${packageName}`).then(res => res.data));